...
export const shadows = { sm: { elevation: 3 }, md: { elevation: 6 }, lg: { elevation: 10 }, glow: { elevation: 8 } };
export const glass = {
    card: { backgroundColor: 'rgba(255, 255, 255, 0.03)', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.1)', elevation: 1 },
    cardLight: { backgroundColor: 'rgba(255, 255, 255, 0.06)', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.15)', elevation: 2 },
    premium: { backgroundColor: 'rgba(251, 191, 36, 0.05)', borderWidth: 1, borderColor: 'rgba(251, 191, 36, 0.2)', elevation: 3 },
    border: 'rgba(255, 255, 255, 0.08)',
    borderBright: 'rgba(255, 255, 255, 0.15)',
};
export const animations = { fast: 200, normal: 400, slow: 800, spring: { tension: 40, friction: 7 } };
