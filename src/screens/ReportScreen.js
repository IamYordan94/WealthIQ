        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                <View style={styles.monthSelector}>
                    ...
                    <Text style={styles.badge}>LATEST</Text>
                </View>

                {/* Score Summary */}
                <View style={styles.scoreCard}>
                    <Text style={styles.scoreLabel}>HealthIQ Score</Text>
                    ...
                    <View style={styles.chartPlaceholder}>
                        ...
                        <View style={[styles.bar, { height: '55%', opacity: 0.5 }]} />
                        <View style={[styles.bar, { height: '45%', opacity: 0.4 }]} />
                        <View style={[styles.bar, { height: '65%', opacity: 0.6 }]} />
                ...
                <View style={styles.breakdownCard}>
                    <View style={styles.breakdownItem}>
                        ...
                        <Text style={[styles.itemValue, { color: colors.success || '#10b981' }]}>22%</Text>
                    </View>
                    ...
                    <View style={styles.breakdownItem}>
                        ...
                        <Text style={[styles.itemValue, { color: colors.error || '#ef4444' }]}>-€450</Text>
                    </View>
                </View>
